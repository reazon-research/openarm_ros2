...
#include "test_openarm_controller.hpp"

using openarm_controller::CMD_MY_ITFS;
using openarm_controller::control_mode_type;
using openarm_controller::STATE_MY_ITFS;

class OpenarmControllerTest : public OpenarmControllerFixture<TestableOpenarmController>
{
};

TEST_F(OpenarmControllerTest, all_parameters_set_configure_success)
{
  SetUpController();
...
TEST_F(OpenarmControllerTest, check_exported_intefaces)
{
  SetUpController();
...
TEST_F(OpenarmControllerTest, activate_success)
{
  SetUpController();
...
TEST_F(OpenarmControllerTest, update_success)
{
  SetUpController();
...
TEST_F(OpenarmControllerTest, deactivate_success)
{
  SetUpController();
...
TEST_F(OpenarmControllerTest, reactivate_success)
{
  SetUpController();
...
TEST_F(OpenarmControllerTest, test_setting_slow_mode_service)
{
  SetUpController();
...
TEST_F(OpenarmControllerTest, test_update_logic_fast)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(OpenarmControllerTest, test_update_logic_slow)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(OpenarmControllerTest, publish_status_success)
{
  SetUpController();
...
TEST_F(OpenarmControllerTest, receive_message_and_publish_updated_status)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
